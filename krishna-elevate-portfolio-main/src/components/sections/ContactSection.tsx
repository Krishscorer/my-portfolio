...
const contactLinks = [
  {
    icon: Mail,
    label: "Email",
    value: "krishnajaiswal276@gmail.com",
    href: "krishnajaiswal276@gmail.com",
    color: "bg-red-500/10 text-red-600 hover:bg-red-500/20",
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    value: "https://www.linkedin.com/in/krishna-j-102560230/",
    href: "https://www.linkedin.com/in/krishna-j-102560230/",
    color: "bg-blue-500/10 text-blue-600 hover:bg-blue-500/20",
  },
  {
    icon: Github,
    label: "Portfolio Docs",
    value: "https://github.com/Krishscorer",
    href: "https://github.com/Krishscorer",
